            ...
            for i_frame in range(num_frames):
                ...
                if 'escape' in keys:
                    if cyton_in:
                        ...
                        np.save(save_file_eeg_trials, np.array(eeg_trials, dtype=object), allow_pickle=True)
                        np.save(save_file_aux_trials, np.array(aux_trials, dtype=object), allow_pickle=True)
                        stop_event.set()
                        board.stop_stream()
