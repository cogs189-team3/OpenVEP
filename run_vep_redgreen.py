...
# save_dir = os.path.join(script_dir, f'data-rg/cyton8_{stim_type}-vep_32-class_{stim_duration}s/sub-{subject:02d}/ses-{session:02d}/')

save_dir = f'data-rg/cyton8_{stim_type}-vep_32-class_{stim_duration}s/sub-{subject:02d}/ses-{session:02d}/' # Directory to save data to
...
text = psychopy.visual.TextStim(win=win, height=0.08, font="Helvetica") # font="Courier"
